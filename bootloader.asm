 ...
 Msg:    db "She should have died hereafter. There would have been a time for such a word. Tomorrow, and tomorrow, and tomorrow, Creeps in this petty pace from day to day."

 EndMsg:

 Start:

 Main:   mov bx, 0006h   ;Set background flag + color
         mov ah, 000Bh   ;Set 2nd background flag
         int 10h         ;Set background color

 Clear:  mov ax, 0600h   ;Clear the screen
         mov cx, 0000h
         mov dx, 184fh
         int 10h
 ...
 Char:   mov ah, 2       ;BH = page, DH = row, DL = column
         ...
         lodsb           ;Load a byte of the message into AL.
                         ...
                         ;next byte read will be next byte of stream
